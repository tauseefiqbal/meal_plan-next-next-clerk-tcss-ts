          ...
          <div className="w-full md:w-2/3 p-6 bg-gray-50">
            ...
            {isLoading ? (
              ...
              <div className="space-y-6">
                ...
                {/* Show management options only if there's an active Stripe subscription */}
                {subscription.subscription.stripeSubscriptionId ? (
                  ...
                  <div className="bg-yellow-50 shadow-md rounded-lg p-6 border border-yellow-200">
                    ...
                    <p className="text-gray-700 mb-4">
                      Your subscription is not currently active or linked to a payment method. 
              ...
              <div className="bg-white shadow-md rounded-lg p-6 border border-emerald-200 text-center">
                <p className="text-gray-600 mb-4">You are not subscribed to any plan.</p>
                <button
                  onClick={() => router.push("/subscribe")}
                  className="px-6 py-2 bg-emerald-500 text-white rounded-md hover:bg-emerald-600 transition-colors"
                >
